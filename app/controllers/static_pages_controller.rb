class StaticPagesController < ApplicationController
  ...
  def index
    @o_all = get_records(params[:static_page], params[:page])
  end
  ...
  def update
    respond_to do |format|
      if @o_single.update_attributes(static_page_params)
        format.html { redirect_to static_pages_url, notice: t("general.successfully_updated") }
  ...
  private
    ...
    def get_records(search, page)
      static_page_query = StaticPage.scoped
